...
CREATE TABLE `history_commodity` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=latin1 COMMENT='历史商品信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='管理员表';
...
INSERT INTO `member` VALUES ('41', 'zjing', '90FA734BB3393E1CF845839E7DFCA387C26424BC', '4xh45L0AaI5Ugj7m2vGmhNl2b6TU6EQX', '张静', '18056796628', null, '\0', '2016-12-08 14:01:10', null);
...
CREATE TABLE `pick` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=latin1 COMMENT='选货单表';
...
CREATE TABLE `pick_commodity` (
  ...
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=latin1 COMMENT='选货单商品表';
...
CREATE TABLE `pick_tracking` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=latin1 COMMENT='选货单追踪记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='角色管理员关联表';
...
CREATE TABLE `sample_tracking` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='寄样跟踪表';
...
CREATE TABLE `send_sample` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='寄样单表';
...
INSERT INTO `send_sample` VALUES ('50', '17', '201612071410000050', '18801285391', '王彬', '湖北武汉', '45', '0', '5', '2016-12-07 14:10:24', '2016-12-07 14:10:24');
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='用户详情表';
...
INSERT INTO `user_detail` VALUES ('27', '1', '王彬', '18801285391', 'http://wx.qlogo.cn/mmopen/9XibKWLOyJBSiaWiaXibOnuXTFFGh0rClicaS0OPlFtgMFFfPn81Mcs0pElIn6IGFmypwQFMlF3D5bvfMRTayPe923xDMGJoLHVDD/0', '湖北武汉', '天济饮片厂', null, '17', '2016-11-10 19:03:21', '2016-12-08 14:28:02');
