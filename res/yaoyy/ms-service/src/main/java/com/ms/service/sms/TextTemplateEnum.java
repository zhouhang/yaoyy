...
public enum TextTemplateEnum {
    ...
    SMS_SAMPLE_APPLY("{1}您提交了一个寄样申请，商品：{2}，我们会在5分钟内给您回复。"), // 用户提交寄样申请确认短信
    ...
    SMS_BOSS_SUPPLIER_SIGN("{1}恭喜您，已成为药优优签约供应商。您可以在药优优公众号右侧 工作台->低价商城供应商 菜单看到您的订单情况，以及对您的商品进行调价。第一次使用请用您的账号：{2}和密码：{3} 进行登录。"),
